...
from Core.O_70__Interaction import Phosphorylation, Dephosphorylation

# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class ComponentBase(Base):
    def __init__(self, inpDat, llOInt=[], lOOth=[], iTp=75):
...
class Component(ComponentBase):
    def __init__(self, inpDat, inpFr, sComp, iTp=75):
        self.inFr = inpFr
    ...
    def ini_Cp_L(self, inpDat, LPr, iTp=75):
        llOI, lOO = [], [LPr]
    ...
    def ini_Cp_S(self, inpDat, SPr, iTp=75):
        llOI, lOO = [], [SPr]
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
        self.descO = GC.S_DESC_S__

    def ini_Cp_K(self, inpDat, KAsK, iTp=75):
        llOI, lOO = [], [KAsK]
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
    ...
    def ini_Cp_OAs(self, inpDat, As, iTp=75):
        llOI, lOO = [], [As]
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
        self.descO = GC.S_DESC_OAS + As.idO

    def ini_Cp_LS(self, inpDat, LPr, SPr, sCpSp1, iTp=75):
        llOI, lOO = [[SPr, LPr]], []
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
    ...
    def ini_Cp_LK(self, inpDat, LPr, KAsK, sCpSp1, iTp=75):
        llOI, lOO = [[KAsK, LPr]], []
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
        self.descO = GC.D_DESC[sCpSp1]
    ...
    def ini_Cp_LSI(self, inpDat, LPr, SPr, iTp=75):
        llOI, lOO = [[SPr, LPr]], []
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
    ...
    def ini_Cp_LSJ(self, inpDat, LPr, SPr, iTp=75):
        llOI, lOO = [[SPr, LPr]], []
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
    ...
    def ini_Cp_LST(self, inpDat, LPr, SPr, iTp=75):
        llOI, lOO = [[SPr, LPr]], []
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
    ...
    def ini_Cp_LKI(self, inpDat, LPr, KAsK, iTp=75):
        llOI, lOO = [[KAsK, LPr]], []
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
    ...
    def ini_Cp_LKJ(self, inpDat, LPr, KAsK, iTp=75):
        llOI, lOO = [[KAsK, LPr]], []
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
    ...
    def ini_Cp_LKT(self, inpDat, LPr, KAsK, iTp=75):
        llOI, lOO = [[KAsK, LPr]], []
        super().__init__(inpDat, llOI, lOO, iTp=iTp)
        self.idO = self.inFr.dSCpSL[self.sCp[:GC.I_S_CP_SEP1]]
