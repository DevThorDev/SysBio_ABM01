...
def iniSystem(inpDG):
    ...
    Pyl01 = Phosphorylation(inpDG, 80, [KAs_AT5G49770, PAs1], 'S839')
    Pyl02 = Phosphorylation(inpDG, 80, [KAs_AT5G49770, PAs2], 'S870')
    Pyl03 = Phosphorylation(inpDG, 80, [NRT2p1, PAs3], 'S21')
    Pyl04 = Phosphorylation(inpDG, 80, [NRT2p1, PAs4], 'S28')
    DePyl01 = Dephosphorylation(inpDG, 80, [KAs_AT5G49770, PAs1],
                                'S839')
    DePyl02 = Dephosphorylation(inpDG, 80, [KAs_AT5G49770, PAs2],
                                'S870')
    DePyl03 = Dephosphorylation(inpDG, 80, [NRT2p1, PAs3], 'S21')
    DePyl04 = Dephosphorylation(inpDG, 80, [NRT2p1, PAs4], 'S28')
    # List of system components -----------------------------------------------
    lSysCmp = [KAs_AT5G49770, PAs1, PAs2, PAs3,
