...
class Interaction(Base):
    def __init__(self, inpDat, iTp, lOInt):
...
class Phosphorylation(Interaction):
    def __init__(self, inpDat, iTp, lOInt, sSpSite):
        assert len(lOInt) == 2
        ...
        print('Initiated "Phosphorylation" base object.')
...
class Dephosphorylation(Interaction):
    def __init__(self, inpDat, iTp, lOInt, sSpSite):
        ...
        print('Initiated "Dephosphorylation" base object.')
